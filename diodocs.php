...
<body>
<?php
       include('dashboard/vigation2.php');
    ?>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li><a href="dashboard/News.php">News</a></li>
            <li><a href="dashboard/displayall.php">Groups,Districts&Organisations</a></li>
            <li><a href="dashboard/vids.php">Videos</a></li>
           <li><a href="dashboard/dispchrist.php">Display Christian</a></li>
           <li><a href="dashboard/programs1.php">Programs&Pubs</a></li>
          </ul>
        </div>
