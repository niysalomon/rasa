...
<div class="tabe-head">
<table><tr><td><a href="index.php">----Back</a></td></tr></table><form action="dispwreport.php" method="POST"><table align="center"><tr>
<td><input type="text" name="search" placeholder="search date"></td>
<td><input type="submit" name="search1" value="search"></td></tr>
</table></form></div>
            ...
            <table border="1" class="table table-striped">
              ...
              if(isset($_POST['search1']))
              {
               @$search=$_POST['search'];
                ...
                $Result=mysqli_query( $conn,"select * from reports where dates like'%$search%'");
