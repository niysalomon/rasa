...
<html lang="en">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="#">Post Diocese Documents</a></li>
             <li><a href="post1.php">News</a></li>
             <li><a href="Nnewspics.php">post Newsphotoes</a></li>
             <li><a href="Nchoirs.php">New Gallery photoes</a></li>
           ...
           <li><a href="postouv.php">group,organisation&Districts</a></li>
            ...
            <li ><a href="NvideoEmb.php">Embed New video</a></li>
             <li><a href="Nfile.php">Post file</a></li>
              <li><a href="discom.php">Communication</a></li>          
            
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Post News Documents</h1>
  ...
  <?php
   global $file_location;
      ...
      include('../connection.php');
              $Result=mysqli_query($conn,'INSERT INTO dfile(id,file,Name,date) VALUES("","'.$file_location.'","'.$about.'",now())');
              if($Result)
									{
  ...
  ?>
		  	 <form role="form" method="post" enctype="multipart/form-data" action='diofile.php'>
    ...
    <div class="table-responsive">
           ...
           <?php
                include('../connection.php');
                $Result=mysqli_query( $conn,"SELECT * FROM dfile");
                  while($row=mysqli_fetch_array($Result))
                  {
                    echo '
                         <tr>
                          ...
                          <td>'.$row["Name"].'</td>
                          <td>'.$row["file"].'</td>';
                          echo  '<td><a href="deletedfile.php?del='.$row["id"].'" 
