...
<html lang="en">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="Nbishopfiles.php">My Useful Documents</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">My Useful Documents</h1>
  ...
  <?php
   global $file_location;
      ...
      include('../connection.php');
              $Result=mysqli_query($conn,'INSERT INTO bfiles(id,file,Name,date) VALUES("","'.$file_location.'","'.$about.'",now())');
              if($Result)
									{
  ...
  ?>
		  	 <form role="form" method="post" enctype="multipart/form-data" action='Nbishopfiles.php'>
    ...
    <div class="table-responsive">
           ...
           <?php
                include('../connection.php');
                $Result=mysqli_query( $conn,"SELECT * FROM bfiles");
                  while($row=mysqli_fetch_array($Result))
                  {
                    echo '
                         <tr>
                          ...
                          <td>'.$row["Name"].'</td>
                          <td>'.$row["file"].'</td>';
                          echo  '<td><a href="deletebi.php?del='.$row["id"].'" 
