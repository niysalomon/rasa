    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <li class="active"><a href="#">Edit Programs of the week</a></li>
            <li><a href="profile44.php">Edit orgs,grps and Distr<span class="sr-only">(current)</span></a></li>            
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h4 class="page-header">Edit this week Programs</h4>
          <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="Editable4.php"></iframe>
          </div>
        </div>
      </div>
    </div>
