...
<html lang="en">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <li class="active"><a href="#">Post News photoes</a></li>
      ...
      $dates=date("d/m/Y");
			...
			$qry="INSERT INTO newspics(id,title,photo,Name,content,date) values('','$Btitle','$file_location','$name','$content','$dates')";
  ...
  <div class="col-md-6 text-center" style="background-color:gray;">
		  	 <form role="form" method="post" enctype="multipart/form-data" action='Nnewspics.php'>
			 	   <div class="form center-block">
				   		<div class="form-group">
							 ...
							 <label style="color:#000000">photo's contents:</label><br />
