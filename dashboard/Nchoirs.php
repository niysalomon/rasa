...
<html lang="en">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <li class="active"><a href="#">Post photoes</a></li>
      ...
      $choir=$_POST['choir'];
			...
			$qry="INSERT INTO gallery(id,title,photo,Name,choir,date) values('','$Btitle','$file_location','$name','$choir','$dates')";
  ...
  <div class="col-md-6 text-center" style="background-color:gray;">
		  	 <form role="form" method="post" enctype="multipart/form-data" action='Nchoirs.php'>
			 	   <div class="form center-block">
				   		<div class="form-group">
							 ...
							 <label style="color:#000000">Owner:</label><br />
							 <input class="form-control" type="text"name="choir"></br>
						</div>
