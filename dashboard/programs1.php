      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">            
            <li class="active"><a href="#">Programs&Pubs</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">
            ...
            echo $_SESSION['name'];
            ?>
          </h2><br /><h4 class="page-header">Publicity</h4>
          <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="table5.php"></iframe>
          </div>

            <h4 class="page-header">Publicity</h4>
          <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="table6.php"></iframe>
          </div>
        </div>
      </div>
    </div>
