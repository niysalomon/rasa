      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li><a href="profile.php">Edit Former members list<span class="sr-only">(current)</span></a></li>
            <li class="active" ><a href="#">Edit New members list</a></li>
            <li><a href="profile2.php">Edit News</a></li>
            <li><a href="profile3.php">Edit Programs of the week</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="Editable2.php"></iframe>
          </div>
        </div>
      </div>
    </div>
