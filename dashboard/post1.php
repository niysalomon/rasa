...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
           ...
           <li><a href="postouv.php">Group,organisation&Districts</a></li>
            <li><a href="Nchoirs.php">Gallery photoes</a></li>  
    ...
    global $file_location;
     ...
     function saveimage($name,$file_location)
     {
      ...
      $qry="INSERT INTO news(Title,Resume,Image,Name,Content,date) values('$Btitle','$Stitle','$file_location','$name','$Content',now())";
  ...
  <div class="col-md-6 text-center" style="background-color:gray;">
         <form role="form" method="post" enctype="multipart/form-data" action='post1.php'>
